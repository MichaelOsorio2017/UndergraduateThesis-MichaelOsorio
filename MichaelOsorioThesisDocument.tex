...
\keywords{Android testing, Automatic exploration, Mobile Apps, Applications, Exploration tools, Empirical study, Comparison.} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
...
\large \textit{A thesis submitted in fulfilment of the requirements\\ for the degree of \degreename}\\%[0.1cm] % University requirement text
\univname\\
\facname\\
